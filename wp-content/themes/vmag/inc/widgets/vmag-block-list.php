<?php
/**
 * Vmag: Block Posts (List)
 *
 * Widget to display latest or selected category posts as on list style.
 *
 * @package VMag
 */
add_action( 'widgets_init', 'vmag_register_block_posts_list_widget' );

function vmag_register_block_posts_list_widget() {
    register_widget( 'vmag_block_posts_list' );
}

class Vmag_Block_Posts_List extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array( 
            'classname' => 'vmag_block_posts_list',
            'description' => __( 'This widget for showing posts from selected category or latest.', 'vmag' )
        );
        parent::__construct( 'vmag_block_posts_list', __( 'VMag: Block Posts(List)', 'vmag' ), $widget_ops );
    }
    ...
    private function widget_fields() {
        ...
        $fields = array(
            ...
            'block_layout' => array(
                ...
                'vmag_widgets_title'        => __( 'Block Posts (List) layout', 'vmag' ),
                        ...
                        <div class="single-post clearfix wow fadeInUp" data-wow-duration="0.7s">
                            ...
                            <div class="post-content-wrapper clearfix">
                                ...
                                <?php 
                                    ...
                                    echo vmag_get_excerpt_content( $post_content, 190 ); 
                                ?>
                            </div>                            
                        </div>
            <?php
