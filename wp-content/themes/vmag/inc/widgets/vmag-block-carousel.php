<?php
/**
 * Vmag: Block Posts (Carousel)
 *
 * Widget to display latest or selected category posts as on carousel style.
 *
 * @package VMag
 */
add_action( 'widgets_init', 'vmag_register_block_posts_carousel_widget' );

function vmag_register_block_posts_carousel_widget() {
    register_widget( 'vmag_block_posts_carousel' );
}

class Vmag_Block_Posts_Carousel extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array( 
            'classname' => 'vmag_block_posts_carousel',
            'description' => __( 'This widget for showing posts from selected category or latest.', 'vmag' )
        );
        parent::__construct( 'vmag_block_posts_carousel', __( 'VMag: Block Posts(Carousel)', 'vmag' ), $widget_ops );
    }
    ...
    private function widget_fields() {
        ...
        $fields = array(
            ...
            'block_layout' => array(
                ...
                'vmag_widgets_title'        => __( 'Block Posts (carousel) layout', 'vmag' ),
                'vmag_widgets_layout_img'   => get_template_directory_uri() .'/inc/assets/images/block-carousel.png',
    ...
    public function widget( $args, $instance ) {
        ...
        echo $before_widget;
    ?>
        <div class="block-post-wrapper wow zoomIn" data-wow-duration="0.7s">
