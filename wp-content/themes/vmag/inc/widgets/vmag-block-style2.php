<?php
/**
 * Vmag: Block Posts (Style 2)
 *
 * Widget to display latest or selected category posts as on slider style.
 *
 * @package VMag
 */
add_action( 'widgets_init', 'vmag_register_block_posts_style2_widget' );

function vmag_register_block_posts_style2_widget() {
    register_widget( 'vmag_block_posts_style2' );
}

class Vmag_Block_Posts_Style2 extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array( 
            'classname' => 'vmag_block_posts_style2',
            'description' => __( 'This widget for showing posts from selected category or latest.', 'vmag' )
        );
        parent::__construct( 'vmag_block_posts_style2', __( 'VMag: Block Posts(Style2)', 'vmag' ), $widget_ops );
    }
    ...
    private function widget_fields() {
        ...
        $fields = array(
            ...
            'block_layout' => array(
                ...
                'vmag_widgets_title'        => __( 'Block Posts (Style2) layout', 'vmag' ),
                'vmag_widgets_layout_img'   => get_template_directory_uri() .'/inc/assets/images/block-style2.png',
